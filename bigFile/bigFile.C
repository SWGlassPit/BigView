...
// If we are defining _FILE_OFFSET_BITS=64, then much of this file is unnecessary.
...
// This syscall macro is deprecated as of kernel version 2.6.20
#if 0
...
//BigFile::Offset
off_t
BigFile::tell(int fd) // give current location in file?
{
//  off_t res=0;
...
BigFile::seek(int fd, off_t offset)
{
  off_t res=0;
//#if defined(_XBS5_LPBIG_OFFBIG)
